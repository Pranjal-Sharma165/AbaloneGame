...
def move_validation(source_coords, dest_coords, board, current_player_color):
    ...
    # Single marble movement validation
    if num_marbles == 1:
    ...
    # Multi-marble movement validation
        ...
        # Check if all marbles move in the same direction
        directions = []
        ...
        # Check if marbles are lined up in the direction of movement
        is_line_push = True
        ...
        for i, dest in enumerate(dest_coords):
            ...
            if dest_tuple in player_marbles_set or dest_tuple in opponent_marbles_set:
                if dest_tuple in player_marbles_set:
                    # Check if trying to move onto another of player's marbles
                    ...
                    # Count opponent marbles in a line
                    ...
                    # Can only push fewer opponent marbles than own marbles
...
def move_marbles(source_coords, dest_coords, board, current_player_color):
    ...
    # Find the front marble (in the direction of movement)
    ...
    if front_marble_idx is not None:
        ...
        if push_tuple in opponent_marbles_set:
            ...
            for marble_tuple in opponent_line:
                ...
                # Add new position if on board, otherwise count as pushed off
